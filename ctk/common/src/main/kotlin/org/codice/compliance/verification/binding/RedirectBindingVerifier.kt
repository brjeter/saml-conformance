...
class RedirectBindingVerifier(override val reqData: SamlConfReqData,
                              override val response: Response) :
        BindingVerifier(reqData, response) {
    ...
    private fun verifyHttpRedirectStatusCode() {
        ...
        if (response.statusCode != HttpStatusCodes.STATUS_CODE_OK
                && response.statusCode != HttpStatusCodes.STATUS_CODE_FOUND
    ...
    private fun verifyNoNullsAndParse(): Map<String, String> {
        ...
        if (reqData.wasRelayStateGiven && paramMap[RELAY_STATE] == null) {
    ...
    private fun decode(paramMap: Map<String, String>): org.w3c.dom.Node {
        ...
        val samlEncoding = paramMap[SAML_ENCODING]
    ...
    private fun verifyRedirectRelayState(encodedRelayState: String?) {
        if (reqData.wasRelayStateGiven || encodedRelayState != null) {
            ...
            if (reqData.wasRelayStateGiven && decodedRelayState != EXAMPLE_RELAY_STATE) {
